...
changed: [localhost] => (item={'failed': 0, 'started': 1, 'finished': 0, 'ansible_job_id': 'j444988280124.157252', 'results_file': '/root/.ansible_async/j444988280124.157252', 'changed': True, 'item': {'image': 'aragast/netology:latestaragast/netology:latest', 'name': 'aragast'}, 'ansible_loop_var': 'item'})
